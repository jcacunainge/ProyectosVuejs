...
<script >
    ...
    import useFormValidations from 'src/composables/UseValidationesForm'


    const { validateApellido, validateName, validateCorreo, validateProfesion, validateTelefono } = useFormValidations()
    ...
    export default defineComponent ({
        ...
        setup() {
            ...
            const { enviarDatos } = informacionService()
