...
<template>
    ...
    <div>
        ...
        <p v-if="appointments.noServicesSelected" class="text-white text-2xl text-center">No hay servicios seleccionados
        </p>
        ...
        <div class="space-y-8" v-if="!appointments.noServicesSelected">
            ...
            <div class="lg:flex gap-5 items-start">
                ...
                <div v-if="appointments.isDateSelected"
                    ...
                    <button v-for="(hour, index) in appointments.hours" :key="index"
